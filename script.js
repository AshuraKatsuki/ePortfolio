...
// Console message
console.log('%c👋 Hello! Welcome to my portfolio', 'font-size: 20px; font-weight: bold; color: #000;');
console.log('%cBuilt with ❤️ using HTML, CSS, and JavaScript', 'font-size: 14px; color: #666;');
